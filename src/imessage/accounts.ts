...
export function listIMessageAccountIds(cfg: FirstClawConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: FirstClawConfig): string {
...
export function listEnabledIMessageAccounts(cfg: FirstClawConfig): ResolvedIMessageAccount[] {
