import type { FirstClawConfig } from "./config.js";
...
function isTelegramConfigured(cfg: FirstClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: FirstClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: FirstClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: FirstClawConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: FirstClawConfig): boolean {
...
function isIMessageConfigured(cfg: FirstClawConfig): boolean {
...
function isGenericChannelConfigured(cfg: FirstClawConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: FirstClawConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: FirstClawConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: FirstClawConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: FirstClawConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: FirstClawConfig, pluginId: string): FirstClawConfig {
...
function registerPluginEntry(cfg: FirstClawConfig, pluginId: string): FirstClawConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
