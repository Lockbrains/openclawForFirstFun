...
function resolveAnthropicDefaultAuthMode(cfg: FirstClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyTalkApiKey(config: FirstClawConfig): FirstClawConfig {
...
export function applyModelDefaults(cfg: FirstClawConfig): FirstClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyLoggingDefaults(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyContextPruningDefaults(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyCompactionDefaults(cfg: FirstClawConfig): FirstClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
