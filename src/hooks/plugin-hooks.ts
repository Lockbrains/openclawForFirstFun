...
import type { FirstClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: FirstClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: FirstClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
