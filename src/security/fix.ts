...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof FirstClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: FirstClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: FirstClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
