...
export const normalizePluginsConfig = (
  config?: FirstClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: FirstClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: FirstClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: FirstClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
