...
function resolveMentionPatterns(cfg: FirstClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: FirstClawConfig | undefined, agentId?: string): RegExp[] {
