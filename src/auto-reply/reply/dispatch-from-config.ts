...
// FirstClaw: TTS removed - stub returns payload unchanged
...
function normalizeTtsAutoMode(_value?: string | null): string | undefined {
  return undefined;
}

function resolveTtsConfig(_cfg?: FirstClawConfig): { mode?: string } {
  return {};
}
