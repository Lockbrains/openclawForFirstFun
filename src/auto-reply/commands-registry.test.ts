...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@firstclaw", { botUsername: "firstclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@firstclaw args", {
        botUsername: "firstclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@firstclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "firstclaw" })).toBe(
      "/help@otherbot",
    );
  });
