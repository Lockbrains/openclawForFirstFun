...
export const DEFAULT_SANDBOX_IMAGE = "firstclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "firstclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "firstclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "firstclaw-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "firstclaw-sbx-browser-";
