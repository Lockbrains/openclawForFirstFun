...
function resolveAvatarSource(cfg: FirstClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: FirstClawConfig, agentId: string): AgentAvatarResolution {
