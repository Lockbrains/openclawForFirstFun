import type { FirstClawConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: FirstClawConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: FirstClawConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[firstclaw]";
}
