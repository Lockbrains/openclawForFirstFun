...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveFirstClawAgentDir() returns mainAgentDir
    process.env.FIRSTCLAW_STATE_DIR = tmpDir;
    process.env.FIRSTCLAW_AGENT_DIR = mainAgentDir;
