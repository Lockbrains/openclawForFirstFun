...
function resolveWatchPaths(workspaceDir: string, config?: FirstClawConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: FirstClawConfig }) {
