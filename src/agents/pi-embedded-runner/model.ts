...
// pi-ai's built-in Anthropic catalog can lag behind FirstClaw's defaults/docs.
...
export function buildModelAliasLines(cfg?: FirstClawConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveFirstClawAgentDir();
