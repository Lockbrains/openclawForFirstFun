...
export const DEFAULT_LOG_DIR = "/tmp/firstclaw";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "firstclaw.log"); // legacy single-file path

const LOG_PREFIX = "firstclaw";
...
function resolveSettings(): ResolvedSettings {
  let cfg: FirstClawConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => FirstClawConfig;
      };
