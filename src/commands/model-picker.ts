...
function resolveConfiguredModelRaw(cfg: FirstClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: FirstClawConfig): string[] {
...
export function applyPrimaryModel(cfg: FirstClawConfig, model: string): FirstClawConfig {
...
export function applyModelAllowlist(cfg: FirstClawConfig, models: string[]): FirstClawConfig {
  const defaults = cfg.agents?.defaults;
