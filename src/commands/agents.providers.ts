...
function resolveDefaultAccountId(cfg: FirstClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: FirstClawConfig): boolean {
...
export function summarizeBindings(cfg: FirstClawConfig, bindings: AgentBinding[]): string[] {
