...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.firstclaw.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("firstclaw hooks list")}`,
      `  ${formatCliCommand("firstclaw hooks enable <name>")}`,
      `  ${formatCliCommand("firstclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
