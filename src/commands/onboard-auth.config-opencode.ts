...
export function applyOpencodeZenProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyOpencodeZenConfig(cfg: FirstClawConfig): FirstClawConfig {
