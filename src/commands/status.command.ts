...
export async function statusCommand(
  ...
  runtime.log(theme.heading("FirstClaw status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("firstclaw security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("firstclaw security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.firstclaw.ai/faq");
  runtime.log("Troubleshooting: https://docs.firstclaw.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("firstclaw status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("firstclaw logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("firstclaw status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("firstclaw gateway probe")}`);
  }
}
