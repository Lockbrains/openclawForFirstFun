...
const ensureFirstClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveFirstClawAgentDir = vi.fn().mockReturnValue("/tmp/firstclaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/firstclaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureFirstClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveFirstClawAgentDir,
}));
