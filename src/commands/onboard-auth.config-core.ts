...
export function applyZaiConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyOpenrouterProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyOpenrouterConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyLitellmProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyLitellmConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyMoonshotProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyMoonshotConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyMoonshotConfigCn(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyKimiCodeProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applySyntheticProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyXiaomiProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: FirstClawConfig): FirstClawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: FirstClawConfig): FirstClawConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyXaiProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: FirstClawConfig): FirstClawConfig {
...
export function applyQianfanProviderConfig(cfg: FirstClawConfig): FirstClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: FirstClawConfig): FirstClawConfig {
