...
import { type FirstClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: FirstClawConfig): string[] {
...
export function listAgentsForGateway(cfg: FirstClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: FirstClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: FirstClawConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: FirstClawConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: FirstClawConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: FirstClawConfig): GatewaySessionsDefaults {
