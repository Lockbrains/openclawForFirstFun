...
// FirstClaw: only iMessage is a core channel. Feishu and BlueBubbles load as plugins.
export const CHAT_CHANNEL_ORDER = ["imessage"] as const;

export type ChatChannelId = (typeof CHAT_CHANNEL_ORDER)[number];

export const CHANNEL_IDS = [...CHAT_CHANNEL_ORDER] as const;

export const DEFAULT_CHAT_CHANNEL: ChatChannelId = "imessage";
...
const CHAT_CHANNEL_META: Record<ChatChannelId, ChannelMeta> = {
  imessage: {
    ...
    docsLabel: "imessage",
    blurb: "iMessage via macOS Messages app.",
