...
export type ChannelAgentToolFactory = (params: { cfg?: FirstClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: FirstClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: FirstClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: FirstClawConfig }) => boolean;
  supportsCards?: (params: { cfg: FirstClawConfig }) => boolean;
