...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: FirstClawConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: FirstClawConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: FirstClawConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: FirstClawConfig): void {
    this.cache.clear();
    if (cfg) {
  ...
  private resetIfConfigChanged(cfg: FirstClawConfig): void {
