...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "firstclaw-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveFirstClawPackageRoot } = await import("./firstclaw-root.js");
    ...
    vi.mocked(resolveFirstClawPackageRoot).mockResolvedValue("/opt/firstclaw");
