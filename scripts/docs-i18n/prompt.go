...
- Keep product names in English: FirstClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the FirstClaw Gateway, use “Gateway 网关”.
