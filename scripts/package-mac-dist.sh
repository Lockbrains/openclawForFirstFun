...
# Output:
# - dist/FirstClaw.app
# - dist/FirstClaw-<version>.zip
# - dist/FirstClaw-<version>.dmg
...
APP="$ROOT_DIR/dist/FirstClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/FirstClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/FirstClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/FirstClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/FirstClaw-$VERSION.dSYM.zip"
