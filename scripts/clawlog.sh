...
show_usage() {
    cat << EOF
clawlog - FirstClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View FirstClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    FirstClaw logs flow through the macOS unified log (subsystem: ai.firstclaw).
