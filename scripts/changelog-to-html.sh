...
if [[ -z "$version_content" ]]; then
  echo "<h2>FirstClaw $VERSION</h2>"
  echo "<p>Latest FirstClaw update.</p>"
  echo "<p><a href=\"https://github.com/firstclaw/firstclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
