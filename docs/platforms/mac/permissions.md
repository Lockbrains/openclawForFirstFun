...
- Same path: run the app from a fixed location (for FirstClaw, `dist/FirstClaw.app`).
...
Workaround: move files into the FirstClaw workspace (`~/.firstclaw/workspace`) if you want to avoid per-folder grants.
