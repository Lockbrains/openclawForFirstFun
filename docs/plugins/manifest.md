...
read_when:
  - You are building a FirstClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (firstclaw.plugin.json)

Every plugin **must** ship a `firstclaw.plugin.json` file in the **plugin root**.
FirstClaw uses this manifest to validate configuration **without executing plugin
