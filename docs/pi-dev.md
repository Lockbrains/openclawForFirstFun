...
This guide summarizes a sane workflow for working on the pi integration in FirstClaw.
...
- Trigger the agent directly:
  - `pnpm firstclaw agent --message "Hello" --thinking low`
...
State lives under the FirstClaw state directory. Default is `~/.firstclaw`. If `FIRSTCLAW_STATE_DIR` is set, use that directory instead.

To reset everything:

- `firstclaw.json` for config
...
- [https://docs.firstclaw.ai/testing](https://docs.firstclaw.ai/testing)
- [https://docs.firstclaw.ai/start/getting-started](https://docs.firstclaw.ai/start/getting-started)
