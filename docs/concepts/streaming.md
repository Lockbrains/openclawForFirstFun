...
FirstClaw has two separate “streaming” layers:
...
When block streaming is enabled, FirstClaw can **merge consecutive block chunks**
...
When draft streaming is active, FirstClaw disables block streaming for that reply to avoid double-streaming.
