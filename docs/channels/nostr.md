...
read_when:
  - You want FirstClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables FirstClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`firstclaw onboard`) and `firstclaw channels add` list optional channel plugins.
...
```bash
firstclaw plugins install @firstclaw/nostr
```

Use a local checkout (dev workflows):

```bash
firstclaw plugins install --link <path-to-firstclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "firstclaw",
        "displayName": "FirstClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "firstclaw@example.com",
        "lud16": "firstclaw@example.com"
      }
    }
  }
}
