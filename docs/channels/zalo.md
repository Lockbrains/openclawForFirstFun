...
- Install via CLI: `firstclaw plugins install @firstclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `firstclaw plugins install ./extensions/zalo`
   - From npm (if published): `firstclaw plugins install @firstclaw/zalo`
...
- Approve via:
  - `firstclaw pairing list zalo`
  - `firstclaw pairing approve zalo <CODE>`
...
- Example: `firstclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `firstclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `firstclaw logs --follow`
