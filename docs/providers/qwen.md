---
summary: "Use Qwen OAuth (free tier) in FirstClaw"
read_when:
  - You want to use Qwen with FirstClaw
...
If you already logged in with the Qwen Code CLI, FirstClaw will sync credentials
