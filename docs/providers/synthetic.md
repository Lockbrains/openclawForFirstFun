---
summary: "Use Synthetic's Anthropic-compatible API in FirstClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. FirstClaw registers it as the
...
Note: FirstClaw's Anthropic client appends `/v1` to the base URL, so use
