---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with FirstClaw"
read_when:
  - You want Xiaomi MiMo models in FirstClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). FirstClaw uses
