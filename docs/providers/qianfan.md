---
summary: "Use Qianfan's unified API to access many models in FirstClaw"
read_when:
...
3. FirstClaw installed on your system
...
4. Copy the API key for use with FirstClaw

## CLI setup

```bash
firstclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [FirstClaw Configuration](/gateway/configuration)
