...
FirstClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.firstclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["firstclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
