---
summary: "Overview of FirstClaw onboarding options and flows"
read_when:
...
FirstClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`firstclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the FirstClaw app when you want a fully guided setup on macOS. Docs:
