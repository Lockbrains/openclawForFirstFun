---
summary: "First-run onboarding flow for FirstClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give FirstClaw">
...
<Step title="CLI">
  ...
  The app can install the global `firstclaw` CLI via npm/pnpm so terminal
