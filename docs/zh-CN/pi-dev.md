...
本指南总结了在 FirstClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 FirstClaw 状态目录下。默认为 `~/.firstclaw`。如果设置了 `FIRSTCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.firstclaw.ai/testing
- https://docs.firstclaw.ai/start/getting-started
