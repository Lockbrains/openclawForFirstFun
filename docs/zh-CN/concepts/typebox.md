...
- 生成的 Swift 模型：`apps/macos/Sources/FirstClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/firstclaw/firstclaw/main/dist/protocol.schema.json
