...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.firstclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.firstclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [FirstClawChatMessage] = messages.compactMap { item in
