...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.firstclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other FirstClaw windows, but below the system’s pop-up menus.
