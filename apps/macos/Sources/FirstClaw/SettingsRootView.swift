...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .firstclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? FirstClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? FirstClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let firstclawSelectSettingsTab = Notification.Name("firstclawSelectSettingsTab")
}
