...
enum UIStrings {
    static let welcomeTitle = "Welcome to FirstClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "firstclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: FirstClawOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: FirstClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g firstclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: FirstClawChatViewModel(
