...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/firstclaw/firstclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/firstclaw/firstclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://firstclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "FirstClawBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "FirstClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "FirstClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FirstClawGitCommit") as? String) ??
            "unknown"
    }
