...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = FirstClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = FirstClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = FirstClawConfigFile.loadDict()
            ...
            FirstClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/firstclaw"
        state.remoteCliPath = ""
        return state
    }
}
