...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.firstclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return FirstClawConfigFile.defaultWorkspaceURL() }
