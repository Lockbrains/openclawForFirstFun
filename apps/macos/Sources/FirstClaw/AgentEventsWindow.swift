...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: FirstClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": FirstClawProtocol.AnyCodable("start"),
                "name": FirstClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
