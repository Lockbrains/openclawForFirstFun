...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.firstclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".firstclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.firstclawCommand(
            subcommand: "gateway",
