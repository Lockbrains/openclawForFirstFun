...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = FirstClawLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = FirstClawLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.firstclaw.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(FirstClawLocationMode.off.rawValue)
                            Text("While Using").tag(FirstClawLocationMode.whileUsing.rawValue)
                            Text("Always").tag(FirstClawLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while FirstClaw is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = FirstClawLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: FirstClawLocationMode {
        FirstClawLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
