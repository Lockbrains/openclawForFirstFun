...
final class ScreenController {
    ...
    /// Callback invoked when an firstclaw:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = FirstClawKitResources.bundle
...
/// Handles navigation policy to intercept firstclaw:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept firstclaw:// deep links.
        if url.scheme?.lowercased() == "firstclaw" {
