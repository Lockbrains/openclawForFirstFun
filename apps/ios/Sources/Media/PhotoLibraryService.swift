...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: FirstClawPhotosLatestParams) async throws -> FirstClawPhotosLatestPayload {
        ...
        var results: [FirstClawPhotoPayload] = []
        ...
        return FirstClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> FirstClawPhotoPayload
    {
