...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.firstclaw.gateway"
    private static let nodeService = "ai.firstclaw.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.firstclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.firstclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("firstclaw-gateway.log")
    }
