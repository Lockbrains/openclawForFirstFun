## FirstClaw Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_firstclaw-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm firstclaw gateway --port 18789 --verbose
```
