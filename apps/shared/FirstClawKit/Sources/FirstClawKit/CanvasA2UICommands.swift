...
public enum FirstClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct FirstClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct FirstClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
