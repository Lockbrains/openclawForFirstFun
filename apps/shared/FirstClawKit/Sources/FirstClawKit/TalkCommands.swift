...
public enum FirstClawTalkCommand: String, Codable, Sendable {
...
public struct FirstClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct FirstClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
