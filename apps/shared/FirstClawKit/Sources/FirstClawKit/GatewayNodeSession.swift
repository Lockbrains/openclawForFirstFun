...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.firstclaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.firstclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: FirstClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
