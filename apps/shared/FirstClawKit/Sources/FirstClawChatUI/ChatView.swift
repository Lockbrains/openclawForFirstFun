...
@MainActor
public struct FirstClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: FirstClawChatViewModel
    ...
    public init(
        viewModel: FirstClawChatViewModel,
    ...
    private var visibleMessages: [FirstClawChatMessage] {
        let base: [FirstClawChatMessage]
    ...
    private func mergeToolResults(in messages: [FirstClawChatMessage]) -> [FirstClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = FirstClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: FirstClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: FirstClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: FirstClawChatMessage) -> String {
