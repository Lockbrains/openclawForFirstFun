...
public typealias FirstClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias FirstClawPlatformImage = UIImage
#endif

public struct FirstClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct FirstClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: FirstClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(FirstClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct FirstClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct FirstClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [FirstClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: FirstClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [FirstClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: FirstClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(FirstClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([FirstClawChatMessageContent].self, forKey: .content) {
...
public struct FirstClawChatHistoryPayload: Codable, Sendable {
...
public struct FirstClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct FirstClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [FirstClawSessionPreviewItem]
}

public struct FirstClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [FirstClawSessionPreviewEntry]

    public init(ts: Int, previews: [FirstClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct FirstClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct FirstClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct FirstClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct FirstClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct FirstClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct FirstClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: FirstClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: FirstClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct FirstClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
