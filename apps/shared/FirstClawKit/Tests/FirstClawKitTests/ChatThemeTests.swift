...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = FirstClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = FirstClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
