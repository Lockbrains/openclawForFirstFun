...
- `fix: <summary> (firstclaw#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (firstclaw#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "firstclaw#$pr_number" || { echo "ERROR: commit subject missing firstclaw#$pr_number"; exit 1; }
