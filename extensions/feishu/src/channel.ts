import type { ChannelMeta, ChannelPlugin, ClawdbotConfig } from "firstclaw/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "firstclaw/plugin-sdk";
