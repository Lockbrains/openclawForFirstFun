...
This directory contains the **BlueBubbles external channel plugin** for FirstClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `firstclaw/plugin-sdk` helpers.
